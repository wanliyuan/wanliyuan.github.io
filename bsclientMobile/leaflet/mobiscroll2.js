...
(function(a, i, b, e) {
    ...
    c.Scroller = function(i, v, U) {
        function ka(u) {
            if (E(u, this) && !d && !T && !A && !n(this) && a.mobiscroll.running && (u.preventDefault(), u.stopPropagation(), V = "clickpick" != m.mode, d = a(".dw-ul", this), B(d), X = (W = ja[y] !== e) ? Math.round( - p.getPosition(d, !0) / x) : j[y], $ = w(u, "Y", !0), r = new Date, O = $, fa(d, y, X, 0.001), V && d.closest(".dwwl").addClass("dwa"), "mousedown" === u.type)) a(b).on("mousemove", ba).on("mouseup", Q)
        }
        function ba(a) {
